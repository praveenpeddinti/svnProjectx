...
var CKEditorComponent = (function () {
    ...
    CKEditorComponent.prototype.ckeditorInit = function (config) {
        ...
        // Set initial value
          console.log('ck data--init----'+this.value+"---"+this._value);
          var thisobj = this;
          setTimeout(function(){
               console.log('ck data--set tout----'+thisobj.value+"---"+thisobj._value);
             thisobj.instance.setData(thisobj._value);  
        ...
        this.instance.on('instanceReady', function (evt) {
            ...
            $('#cke_'+editorName+' iframe').contents().find("html").bind('dragover', function(e) {
                $('#dropble').addClass("dragdrop"); 
            });
    ...
    CKEditorComponent.prototype.writeValue = function (value) {
        ...
        if (this.instance){
          ...
          var editorName =  this.instance.name;
