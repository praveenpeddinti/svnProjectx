...
var Dropdown = (function () {
    ...
    Dropdown.prototype.ngOnInit = function () { 
        this.optionsToDisplay = this.displayOptions;
        this.updateSelectedOption(null);
    };
    Dropdown.prototype.ngDoCheck = function () {
       // alert("ngDoCheck");
        var changes = this.differ.diff(this.options);
        //alert(changes+"---"+this.initialized);
        if (changes && this.initialized) {
            //alert("This__Option___"+JSON.stringify(this.displayOptions));
           //  this.optionsToDisplay = this.options;
            if(this.displayOptions || this.displayOptions!= null ||  this.displayOptions!= undefined ){
                 this.optionsToDisplay = this.displayOptions;
            }
  ...
  document.body.appendChild(this.panel);
    ...
    Object.defineProperty(Dropdown.prototype, "typeD", {
        get: function () {
            return (this.editable && this.value) ? this.value : (this.selectedOption ? this.selectedOption.type : null);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Dropdown.prototype.updateSelectedOption = function (val) { 
        //alert('update--'+JSON.stringify(this.options));
        this.selectedOption = this.findOption(val, this.options);
        if (!this.selectedOption && this.options && this.options.length && !this.editable) {
    ...
    Dropdown.prototype.onMouseclick = function (event, input) { 
        ...
        if (!this.itemClick) {
            input.focus();
            if (this.panelVisible && className!='filter_label')
                this.hide();
            else {
    ...
    Dropdown.prototype.show = function (panel, container) {
        ...
        if (this.options && this.options.length) {
            this.panelVisible = true;
             setTimeout(function(){
         var className = $('#filter_dropdown').find(' > label').attr('class');
        if(className== undefined){
           // $('#filter_dropdown').find(' > li.general:eq(0)').before('<label class="filter_label" style="color:#4F9EB5;width:100%;">Filter</label>');
          //  $('#filter_dropdown').find(' > li.bucket:eq(0)').before('<label class="filter_label" style="color:#4F9EB5;width:100%;padding-top:5px;">Bucket</label>');
            $('#filter_dropdown').find('> label.filter_label').unbind('click');
    }
        },0)
    ...
    ], Dropdown.prototype, "displayOptions", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Array)
