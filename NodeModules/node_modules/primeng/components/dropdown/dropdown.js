...
var Dropdown = (function () {
    ...
    Object.defineProperty(Dropdown.prototype, "displayOptions", {
        get: function () {
    ...
    Dropdown.prototype.updateSelectedOption = function (val) { //alert("updateSelectedOption___"+JSON.stringify(this.options))
        this.selectedOption = this.findOption(val, this.options);
        if (!this.placeholder && !this.selectedOption && this.options && this.options.length && !this.editable) {
...
__decorate([
    ...
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], Dropdown.prototype, "displayOptions", null);
Dropdown = __decorate([
    core_1.Component({
        selector: 'p-dropdown',
